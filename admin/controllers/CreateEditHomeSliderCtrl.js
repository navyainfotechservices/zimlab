/**
 * @ngdoc function
 * @name zimlabApp.controller:CreateEditHomeSliderCtrl
 * @description
 * # MainCtrl
 * Controller of the zimlabApp
 */
angular.module('zimlabApp')
    .controller('CreateEditHomeSliderCtrl', function ($scope, NavigationService, $state,$stateParams, $uibModal) {
        ...
        $scope.getOneHome = function () {
            ...
            if (id) {
                NavigationService.apiCall('homeSlider/getOneHomeSlider', { id:id }, function (data) {
        ...
        $scope.saveHome = function (value) {
            ...
            var url = '';
            if($stateParams.id) {
                url = 'homeSlider/updateHomeSlider';                
            } else {
                url = 'homeSlider/saveHomeSlider';
            }
            NavigationService.apiCall(url, obj, function (data) {
                if (data.statusCode == 0) {
                    $state.go('dashboard.homeListSlider');
                } else {
        ...
        //   animation: true,
        //   templateUrl: 'views/homeSlider/addEditHomeSlider.html',
        //   scope: $scope,
        //   size: 'md'
        // }); 
        //   }
